package shop.project.vendiverse.security;
...
public class TokenService {
    ...
    public String loginSuccessUserGenerateRefreshToken(User user, String deviceId) {
        ...
        String refreshToken = tokenProvider.generateToken(user, REFRESH_TOKEN_DURATION, userDetails);
    ...
    public String loginSuccessUserGenerateAccessToken(User user, String deviceId) {
        UserDetailsImpl userDetails = new UserDetailsImpl(user);
        String accessToken = tokenProvider.generateToken(user, ACCESS_TOKEN_DURATION, userDetails);
